...
- [Python](content/python/)
    ...
    - [frameworks](content/python/frameworks/)
        - [web/fastapi](content/python/frameworks/web/fastapi.md)
        - [web/flask](content/python/frameworks/web/flask.md)
    - [libraries](content/python/libraries/)
